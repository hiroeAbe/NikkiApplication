...
public class NikkiAdapter2 extends RealmBaseAdapter<Nikki> {
    ...
    public NikkiAdapter2(Context context, RealmResults<Nikki> realmResults, boolean automaticUpdate) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            viewHolder.good = (TextView)convertView.findViewById(android.R.id.text1);
